...
(
  ...
  initial begin
    $dumpfile("/home/jfriday/SensorSoC/scripts/ml/waveform_hkw6gg6z.vcd");
    $dumpvars(0, "taketwo");
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      case(th_ctrl)
        ...
        th_ctrl_34: begin
          if(th_ctrl == 34) begin
            rdata_76 <= { _memory_mem[960 + ((_th_ctrl_bat_4 << 1) + _th_ctrl_i_5) * 16 / 8 + 1], _memory_mem[960 + ((_th_ctrl_bat_4 << 1) + _th_ctrl_i_5) * 16 / 8 + 0] } >> ((_th_ctrl_bat_4 << 1) + _th_ctrl_i_5) * 16 % 8;
          end 
          th_ctrl <= th_ctrl_35;
        end
        th_ctrl_35: begin
